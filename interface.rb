...
loop do
  ...
  next unless method == 'open_all_cards' || (game.player.cards.size == 3 && game.dealer.cards.size == 3)
  puts ''
  game.open_all_cards
  puts ''
  ...
  game.player.cards = []
  game.dealer.cards = []
  Player::METHODS = %w[skip_a_move add_card open_all_cards].freeze
